...
})().directive('customMultiUpload', function() {
    return {
      controllerAs: 'ctrl',
      controller: function PbMultiUploadCtrl($scope, $sce, $element, widgetNameFactory, $timeout, $log, gettextCatalog) {
  var ctrl = this;
